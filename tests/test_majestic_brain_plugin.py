"""Tests for the Majestic Brain memory provider plugin.
...
NOTE: Provider tests (TestMajesticBrainProvider) require
...
class TestImportPaths:
    """Verify majestic_brain import paths work."""
...
# ===========================================================================
# Store tests (MajesticBrainStore)
# ===========================================================================
...
class TestMajesticBrainStore:
    ...
    def test_migrates_legacy_notes_and_backfills_hashes(self, tmp_path):
        ...
        store = MajesticBrainStore(db_path)
